...
public class MinesweeperController implements Serializable {
    ...
    /**
     * The MinesweeperController Constructor.
     *
     * @param mod The model the controller will use.
     */
     ...
     * @param firstMoveR The row number of the bomb placement.
     * @param firstMoveC The col number of the bomb placement.
     */
     ...
     * notify the Observer.
     * @param row The row selected for the move.
     * @param col The column selected for the move.
     */
     ...
     * @param row The row selected for the flag.
     * @param col The column selected for the flag.
     */
    ...
    /**
     * Returns the starting variables of the model.
     * @return int[]
     */
    ...
    /**
     * Adds an observer to the model. Required for use with Observable.
     * @param observer of the model.
     */
     ...
     * @param colors The supplied colors of the current game state.
     */
