...
public class GameWindow extends Application implements Observer {
    ...
    /**
     * The constructor for the GameWindow.
     *
     * @param controller The controller used to communicate with the model.
     * @param colors The colors specified by the user (Theme selection).
     */
    ...
    /**
     * Converts RGB value string to HEX color values.
     * @param colors The supplied colors by the user.
     * @return Hex color values split into three index String[].
     */
    ...
    /**
     * Initializes the View's Game Window.
    ...
    public void start(Stage stage) {
        ...
        // VBox Containing Main Menu Bar, Game Session Timer and GameGrid.
        VBox vBox = new VBox(menuBar, game_time, root);
    ...
    /**
     * This method updates the tiles of the board with what is set on the back
     * end in Model's Board.
     * @param board The board of the game from Model.
     */
    ...
    /**
     * This method updates the end state of the game.
     * @param board The board from the Model.
     * @param won The status of the game if the player won.
     */
    ...
    /**
     * The Bomb animation if a bomb is struck.
     */
    ...
    /**
     * This class animates the bomb explosion via Transition.
     */
    public class AnimateBomb extends Transition {
        ...
        /**
         * This method determines the animation attributes of the Bomb.
         *
         * @param imageView A view of the animation sprite.
         * @param duration How long we want the animation to play.
         * @param count The number of times the animation will play over.
         * @param cols The number of columns in the sprite.
         * @param offset_x How much the view will need to change by in order to
         *                get to the next part of the animation sprite.
         * @param offset_y Single Column used.
         * @param width The width of each sprite individually accross the
         *              entire image.
         * @param height The height of each inidividual sprite across the
         *               entire image.
         */
        ...
        /**
         * Required method to use the timeline.
         * @param v Defines the current position with the animation.
         */
        @Override
    ...
    /**
     * Updates the View with the Model state.
     *
